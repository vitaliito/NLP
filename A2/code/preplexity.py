...
if __name__ == "__main__":
    ...
    print('English Language Model (delta = 0.0001) :', preplexity(LM_e, test_dir, language, smoothing = True, delta = 0.0001))
    print('English Language Model (delta = 0.001) :', preplexity(LM_e, test_dir, language, smoothing = True, delta = 0.001))
    print('English Language Model (delta = 0.01) :', preplexity(LM_e, test_dir, language, smoothing = True, delta = 0.01))
    print('English Language Model (delta = 0.1) :', preplexity(LM_e, test_dir, language, smoothing = True, delta = 0.1))
    ...
    print('French Language Model (delta = 0.0001) :', preplexity(LM_f, test_dir, language, smoothing = True, delta = 0.0001))
    print('French Language Model (delta = 0.001) :', preplexity(LM_f, test_dir, language, smoothing = True, delta = 0.001))
    print('French Language Model (delta = 0.01) :', preplexity(LM_f, test_dir, language, smoothing = True, delta = 0.01))
    print('French Language Model (delta = 0.1) :', preplexity(LM_f, test_dir, language, smoothing = True, delta = 0.1))